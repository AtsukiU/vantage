  ...
  return (
    <div>
      <div className="flex items-center gap-1.5">
        ...
        <h3 className="text-[13px] font-extrabold text-[var(--foreground)]">1ヶ月先の株価傾向(過去データ参考値)</h3>
      </div>
      ...
      <div className="mt-3 grid grid-cols-2 gap-2 sm:grid-cols-4">
        <div className="rounded-lg bg-[var(--fill-pill)] px-2.5 py-2 text-center">
          <div className="text-[10.5px] text-[var(--text-secondary)]">上昇していた割合</div>
          <div className="mt-0.5 text-[15px] font-extrabold" style={{ color: forecast.winRatePct >= 50 ? GOOD : BAD }}>
            {forecast.winRatePct.toFixed(1)}%
          </div>
        </div>
        <div className="rounded-lg bg-[var(--fill-pill)] px-2.5 py-2 text-center">
          <div className="text-[10.5px] text-[var(--text-secondary)]">平均リターン</div>
        ...
        <div className="rounded-lg bg-[var(--fill-pill)] px-2.5 py-2 text-center">
          <div className="text-[10.5px] text-[var(--text-secondary)]">中央値</div>
        ...
        <div className="rounded-lg bg-[var(--fill-pill)] px-2.5 py-2 text-center">
          <div className="text-[10.5px] text-[var(--text-secondary)]">上下10-90%レンジ</div>
